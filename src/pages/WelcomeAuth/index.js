...
const WelcomeAuth = ({ navigation }) => {
  ...
  return (
    <View style={styles.wrapper.page}>
      ...
      <ActionButton desc="atau, silahkan daftar jika belum memiliki akun" title="Daftar" onPress={() => handleGoTo('Register')} />
    </View>
  )
}
...
const styles = {
  wrapper: {
    ...
    illustration: {
      width: 219, height: 117, marginBottom: 10
    }
  },
  text: {
    welcome: {
      fontSize: 18, fontWeight: 'bold', color: colors.default, marginBottom: 76
    }
  }
}
